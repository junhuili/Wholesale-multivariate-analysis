...
ggpairs(data=l1sale, columns=seq(3,8), color="Channel", upper = list(params = c(size = 4))) + ggplot2::theme_bw()
```
...
plot(si.ag3, col=group_color, which=2,
...
plot(si.pam3, col=group_color, which=2, main="Silhouette plot for 3 groups found by PAM")
```
